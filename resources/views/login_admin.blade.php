...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="{{ route('login_action') }}" method="POST">@csrf
          ...
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" style="padding: 5px;">SIGN IN</button>
            <a href="{{ url('register_admin') }}" class="btn btn-block btn-success" style="padding: 5px;">SIGN UP</a>
          </div>
        </form>
      </div>
    </section>
